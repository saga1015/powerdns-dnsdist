...
-- Retrieved from: hhttps://github.com/yspmedia/powerdns-dnsdist/new/master/dnsdist
...
-- The difference is this function will take the server orders into account before
